...
//
    ...
    */
    DLL_EXPORT ALIGNED_BUF alloc_aligned(size_t buffer_size, DWORD protect, ULONGLONG desired_base=NULL);

    /**
    Frees buffer allocated by alloc_aligned.
    */
    DLL_EXPORT bool free_aligned(ALIGNED_BUF buffer, size_t buffer_size=0);
    ...
    */
    DLL_EXPORT bool free_pe_buffer(ALIGNED_BUF buffer, size_t buffer_size=0);
